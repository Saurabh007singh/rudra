  ...
  return (
    <>
      ...
      <div className="absolute bg-pink-500 rounded-lg">
        ...
        >
          <p className="mt-4 text-white text-opacity-65 text-2xl">Login Now</p>
          ...
          <div className="flex flex-col items-center text-blue-700"><span>Not Having An Account?</span><span><Link to="/auth/register">Register Here</Link></span></div>
        </form>
