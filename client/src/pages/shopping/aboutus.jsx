    ...
    <div className="flex flex-col w-full ">
      ...
      <div className="flex flex-col  items-center mt-10 mb-20">
        ...
        <p className="text-center lg:mx-40 mx-5">
          ...
          and that's why we're constantly striving to innovate and improve. We
          have launched our first offline store in Kolkata so that customers can
          experience our products firsthand. With more than 7000 products
          curated across 8 categories, we have everything our patrons need to
          create a space that they truly love.
        </p>
      </div>
